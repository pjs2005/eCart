class ItemsInCartsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @items_in_cart.save
        format.html { redirect_to @items_in_cart.cart, notice: 'Items in cart was successfully created.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to items_in_carts_url, notice: 'Items in cart was successfully destroyed.' }
